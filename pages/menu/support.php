...
<?php if(GetPanelUserSteam($_SESSION['steamid'])['hs'] == 1){ ?><li<?php if($_GET['page'] == "support_houses" or $_GET['page'] == "support_containers" or $_GET['page'] == "support_container"){echo ' class="active"';} ?>><a href="?page=support_houses"><i class="fa fa-home"></i> <span>Hausliste</span></a></li><?php } ?>
