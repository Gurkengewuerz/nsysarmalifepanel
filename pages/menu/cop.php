...
<?php if(GetPanelUserSteam($_SESSION['steamid'])['wc'] == 1){ ?><li<?php if($_GET['page'] == "cop_players"){echo ' class="active"';} ?>><a href="?page=cop_players"><i class="fa fa-users"></i> <span>Spielerlist</span></a></li><?php } ?>
